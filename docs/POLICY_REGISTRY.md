...
| Policy ID   | Rule summary                                                                                                                                                   | Canonical source                                                                                                                                    |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| QA-001      | QA assignee may activate a draft Test Case only in the deterministically proven scope of their QA Subtask; PO is notified and may request revision or archive. | [ADR-015](adr/ADR-015-QA-DIRECT-TEST-CASE-ACTIVATION.md), [Workflow §5](2_WORKFLOW_AND_ROLES.md#5-manajemen-pengujian-native-qa-qa-test-management) |
