...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const baseStyles =
    'inline-flex items-center gap-1.5 font-semibold rounded-full border transition-colors whitespace-nowrap shrink-0';
  ...
  const variantStyles = {
    brand:
      'bg-[#B1E743]/20 text-[#141413] border-[#B1E743]/50 dark:bg-[#B1E743]/20 dark:text-[#B1E743] dark:border-[#B1E743]/40',
    passed:
    ...
    draft:
      'bg-stone-100 text-stone-700 border-stone-300 dark:bg-stone-800/90 dark:text-stone-300 dark:border-stone-700',
    info: 'bg-stone-100 text-stone-800 border-stone-300 dark:bg-stone-800/80 dark:text-stone-200 dark:border-stone-700',
    neutral:
      'bg-stone-100 text-stone-700 border-stone-300 dark:bg-stone-800/80 dark:text-stone-300 dark:border-stone-700',
  };
